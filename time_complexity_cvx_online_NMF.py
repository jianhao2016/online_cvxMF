...
if __name__ == '__main__':
    ...
    # test
    df_centroids_nmf.to_pickle('results_logging/nmf_centroid_df_{}'.format(cluster_size))
    ...
    df_centroids.to_pickle('results_logging/ocmf_centroid_df_{}'.format(cluster_size))
    ...
    df_x_hat.to_pickle('results_logging/x_hat_df_{}'.format(cluster_size))
    ...
    df_centroids_omf.to_pickle('results_logging/omf_centroid_df_{}'.format(cluster_size))
    ...
    df_centroids_cnmf.to_pickle('results_logging/cmf_centroid_df_{}'.format(cluster_size))
    # ----------------------------------------------------
